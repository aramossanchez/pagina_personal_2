    ...
    '>
      ...
      '>
        ...
        '>
          ...
          <div className='
            w-full flex flex-row mb-16 justify-center
        ...
        '>
          ...
          <p className='text-lg mt-4'>He comprobado que me encanta estar en un grupo de trabajo en el que se aportan <span className='text-titleFontColor font-medium'>ideas</span> y <span className='text-titleFontColor font-medium'>soluciones</span> por <span className='text-titleFontColor font-medium'>todas las partes</span> involucradas en el desarrollo. Estos grupos donde se dialoga, se escucha a todo el mundo y en los que se ponen en la balanza todas las opiniones, bajo mi experiencia, traen los <span className='text-titleFontColor font-medium'>mejores resultados</span>.</p> */}
            ...
            <div className='w-full flex flex-col gap-1'>
              ...
              <p className='text-lg mt-2'>I've found that I really enjoy being part of a team where <span className='text-titleFontColor font-medium'>ideas</span> and <span className='text-titleFontColor font-medium'>solutions</span> come from <span className='text-titleFontColor font-medium'>all parties</span> involved in the development. These groups, where dialogue is encouraged, everyone is heard, and all opinions are weighed, in my experience, yield the <span className='text-titleFontColor font-medium'>best results</span>.</p>
            </div>
            <div className='
